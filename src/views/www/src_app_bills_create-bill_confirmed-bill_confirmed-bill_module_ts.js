...
/* harmony import */ var _confirmed_bill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confirmed-bill */ 32031);
/* harmony import */ var _confirmed_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./confirmed-routing.module */ 25088);
/* harmony import */ var _bill_print_details_bill_print_details_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../bill-print-details/bill-print-details.module */ 52267);
...
/* harmony import */ var _confirmed_bill_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./confirmed-bill.html?ngResource */ 39475);
/* harmony import */ var _confiremd_bill_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confiremd-bill.scss?ngResource */ 77943);
...
/* harmony import */ var src_app_providers_alert_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/providers/alert.service */ 75412);
/* harmony import */ var src_app_providers_cart_service_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/providers/cart-service.service */ 94422);
/* harmony import */ var src_app_providers_http_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/providers/http.service */ 85030);
/* harmony import */ var src_app_providers_snackbar_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/providers/snackbar.service */ 40415);
/* harmony import */ var src_app_providers_utilservice_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/providers/utilservice.service */ 40847);
/* harmony import */ var src_model_util__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/model/util */ 17699);
...
let ConfiremdBillPage = class ConfiremdBillPage {
  constructor(router, activeRoute, cartService, storeage, util, snack, alertServc, altrCtrl, httpService) {
    ...
    this.onDone = () => {
      this.alertServc.presentAlert(this.altrCtrl, 'Confirm', 'Are you sure, you want to crate the bill?', {
        ok: 'Yes',
        cancel: 'No'
      }, () => {
    ...
    this.uploadBill = () => {
      ...
      if (this.BILLING_ADD) {
        this.httpService.post(src_model_util__WEBPACK_IMPORTED_MODULE_9__.ApiEndPoint.BILL_ADD, billReq).then(e => {
          ...
          const billFinal = e.responseObject;
          this.util.printBill({ ...billFinal,
...
/* harmony import */ var _confirmed_bill__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./confirmed-bill */ 32031);
