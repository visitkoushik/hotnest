...
let MonthPickerComponent = class MonthPickerComponent {
    ...
    chosenHandler(normalizedMonth, datepicker, mesIni, mesFin) {
...
YearPickerModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _material_module__WEBPACK_IMPORTED_MODULE_1__.MaterialModule, _pipe_pipe_module__WEBPACK_IMPORTED_MODULE_2__.PipeModule],
...
let ReportsPage = class ReportsPage {
    ...
    ngOnInit() {
        ...
        this.router.events.subscribe((event) => {
            ...
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_8__.NavigationError) {
                // Hide loading indicator
...
ReportsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
...
module.exports = "<mat-form-field appearance=\"fill\" class=\"yeartoggle\">\n  <mat-label>{{ label }}</mat-label>\n  <mat-date-range-input [rangePicker]=\"picker\" [max]=\"maxDate\">\n    <input\n      matStartDate\n      placeholder=\"Start Year\"\n      formControlName=\"mesIni\"\n      #mesIni\n    />\n\n    <input matEndDate placeholder=\"End Year\" formControlName=\"mesFin\" #mesFin />\n  </mat-date-range-input>\n  <mat-datepicker-toggle matSuffix [for]=\"picker\"></mat-datepicker-toggle>\n  <mat-date-range-picker\n    id=\"picker\"\n    #picker\n    disabled=\"false\"\n    startView=\"multi-year\"\n    (yearSelected)=\"chosenHandler($event, picker, mesIni, mesFin)\"\n    (click)=\"(true)\"\n  >\n  </mat-date-range-picker>\n</mat-form-field>\n";
